      ...
      >
        <div className="border-b border-gray-200 pb-3 dark:border-gray-800">
          ...
          <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
            {displayEmail || "Sin correo vinculado"}
          </span>
        </div>
